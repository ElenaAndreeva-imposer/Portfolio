...
const registerValidation = yup.object().shape({
    ...
    lastName: yup.string(),
    email: yup.string().email('Введите ваш E-mail').required('Пожалуйста, заполните это поле'),
    password: yup.string().min(10, 'Хороший пароль содержит не меньше 10 символов').required('Пожалуйста, заполните это поле'),
